...
- Monitor the guard-aware hedge dampers (PnL guard → clip ×0.65, cross 8 bps, cap 9 bps) and emergency mode (≥10 s block → clip ×1.4, +6 bps cross) and adjust thresholds if they chatter.
