...
- ✅ Guard-aware dampening: when `maker_pnl_guard_active` is true, hedger shrinks clips to ×0.50, drops taker cross to 8 bps, and caps slippage at 9 bps to preserve maker edge.
